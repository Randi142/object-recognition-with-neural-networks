...
while True:
    ...
    if distance < 15:
        ...
        with picamera.PiCamera() as camera:
            ...
            camera.capture("/home/pi/Desktop/newimage.jpg") # your image path
        ...
        #declare model
        model = tf.keras.models.load_model("your model path") # your model path
        
        #input & predict via model
        prediction = model.predict([prepare('/home/pi/Desktop/newimage.jpg')]) # your image path
